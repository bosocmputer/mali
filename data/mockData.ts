...
export const MOCK_TASKS: Task[] = [
  // ── OVERDUE (เกินกำหนด 3–6 วัน — วันนี้คือ 9 พ.ค. 2569) ────────────────────
  {
    ...
    priority: "CRITICAL",
    mddScore: 98.5,
    note: "รอเอกสารจากบริษัท/ห้างหุ้นส่วนฯ ติดต่อซ้ำหลายครั้งแล้ว",
  ...
  },
  {
    ...
    priority: "CRITICAL",
    mddScore: 96.0,
    note: "บริษัท/ห้างหุ้นส่วนฯไม่ตอบ LINE รอดำเนินการ",
    createdAt: "2026-04-01T00:00:00.000Z",
  ...
  // ── TODO — ครบกำหนดเร็วๆ นี้ ──────────────────────────────────────────────
  {
    ...
    priority: "LOW",
    mddScore: 0,
    evidenceUrls: ["https://storage.mali.app/evidence/task-4-vat-mar2026.pdf"],
    note: "ยื่น VAT เดือน มี.ค. เรียบร้อย ไม่มีภาษีต้องชำระเพิ่ม",
  ...
  },
  {
    ...
    priority: "LOW",
    mddScore: 0,
    evidenceUrls: ["https://storage.mali.app/evidence/task-5-vat-mar2026.pdf"],
  ...
  },
  {
    ...
    priority: "LOW",
    mddScore: 0,
    evidenceUrls: ["https://storage.mali.app/evidence/task-6-vat-mar2026.pdf"],
    note: "ตรวจสอบใบกำกับภาษีครบถ้วน ยื่นเรียบร้อย",
  ...
  },
  {
    ...
    priority: "LOW",
    mddScore: 0,
    evidenceUrls: ["https://storage.mali.app/evidence/task-7-wht1-mar2026.pdf"],
    note: "ยื่นหักภาษี ณ ที่จ่ายเงินเดือน มี.ค. เรียบร้อย",
  ...
  },
  {
    ...
    priority: "LOW",
    mddScore: 0,
    evidenceUrls: ["https://storage.mali.app/evidence/task-8-wht3-mar2026.pdf"],
    note: "ยื่น e-Withholding Tax เรียบร้อย",
  ...
  },
  {
    ...
    priority: "LOW",
    mddScore: 0,
    evidenceUrls: ["https://storage.mali.app/evidence/task-16-cit50-fy2025.pdf"],
    note: "ยื่น ภ.ง.ด.50 รอบบัญชี ก.ค.68–มิ.ย.68 เรียบร้อย",
  ...
  },
  {
    ...
    priority: "LOW",
    mddScore: 0,
    evidenceUrls: ["https://storage.mali.app/evidence/task-17-cit50-fy2025.pdf"],
    note: "ยื่น ภ.ง.ด.50 รอบบัญชี ก.ค.68–มิ.ย.68 พร้อมชำระภาษีเรียบร้อย",
    createdAt: "2025-07-01T00:00:00.000Z",
  ...
  // ── SUBMITTED — เดือนก่อนๆ ─────────────────────────────────────────────────
  {
    ...
    priority: "LOW",
    mddScore: 0,
    evidenceUrls: ["https://storage.mali.app/evidence/task-20-vat-mar2026.pdf"],
  ...
  },
  {
    ...
    priority: "LOW",
    mddScore: 0,
    evidenceUrls: ["https://storage.mali.app/evidence/task-21-wht-feb2026.pdf"],
  ...
  },
  {
    ...
    priority: "LOW",
    mddScore: 0,
    evidenceUrls: ["https://storage.mali.app/evidence/task-22-cit-fy2025.pdf"],
  ...
  },
  {
    ...
    priority: "LOW",
    mddScore: 0,
    evidenceUrls: ["https://storage.mali.app/evidence/task-23-vat-feb2026.pdf"],
    note: "ยื่นผ่านระบบ RD Smart Tax เรียบร้อย",
  ...
  },
  {
    ...
    priority: "LOW",
    mddScore: 0,
    evidenceUrls: ["https://storage.mali.app/evidence/task-24-wht3-feb2026.pdf"],
    createdAt: "2026-02-20T00:00:00.000Z",
  ...
  },
  {
    ...
    priority: "LOW",
    mddScore: 0,
    evidenceUrls: ["https://storage.mali.app/evidence/task-25-wht3-feb2026.pdf"],
  ...
  },
  {
    ...
    priority: "LOW",
    mddScore: 0,
    evidenceUrls: ["https://storage.mali.app/evidence/task-26-vat-mar2026.pdf"],
    createdAt: "2026-03-20T00:00:00.000Z",
    updatedAt: "2026-04-12T00:00:00.000Z",
  },
  {
    ...
    priority: "LOW",
    mddScore: 0,
    evidenceUrls: ["https://storage.mali.app/evidence/task-27-vat-mar2026.pdf"],
  ...
  },
  {
    ...
    priority: "LOW",
    mddScore: 0,
    evidenceUrls: ["https://storage.mali.app/evidence/task-29-cit51-hy2025.pdf"],
  ...
  },
  {
    ...
    priority: "LOW",
    mddScore: 0,
    evidenceUrls: ["https://storage.mali.app/evidence/task-30-wht1-mar2026.pdf"],
    createdAt: "2026-03-25T00:00:00.000Z",
    updatedAt: "2026-04-05T00:00:00.000Z",
  },

  // ── พ.ค. 2569 — งานเดือนปัจจุบัน (วันนี้ 6 พ.ค. 2569) ──────────────────────

  // ภ.ง.ด.1 เดือน เม.ย. → due 15 พ.ค. 2569
  {
    id: "task-31",
    clientId: "client-1",
    client: c1,
    ...
    assignedUserId: "user-2",
    assignedUser: u2,
    fiscalYearEndDate: "2026-04-30T00:00:00.000Z",
  ...
  },
  {
    ...
    priority: "HIGH",
    mddScore: 89.5,
    note: "รวบรวมข้อมูลเงินเดือนพนักงานแล้ว กำลังคำนวณ",
    createdAt: "2026-04-25T00:00:00.000Z",
  ...
  // ภ.พ.30 เดือน เม.ย. → due 23 พ.ค. 2569
  {
    id: "task-34",
    clientId: "client-1",
    client: c1,
  ...
  },
  {
    ...
    priority: "MEDIUM",
    mddScore: 72.1,
    note: "รวบรวมใบกำกับภาษีซื้อ-ขายแล้ว กำลังตรวจสอบ",
    createdAt: "2026-04-28T00:00:00.000Z",
    updatedAt: "2026-05-02T00:00:00.000Z",
  },

  // ── มิ.ย. 2569 — งานเดือนถัดไป ──────────────────────────────────────────────

  // ภ.ง.ด.1 เดือน พ.ค. → due 15 มิ.ย. 2569
  {
    id: "task-38",
    clientId: "client-4",
    client: c4,
    taxTypeId: "tt-11",
    taxType: c4.taxTypes[1], // ภ.ง.ด.3 (ใช้ ภ.ง.ด.3 เพราะ client-4 ไม่มี ภ.ง.ด.1)
    assignedUserId: "user-3",
    assignedUser: u3,
    fiscalYearEndDate: "2026-05-31T00:00:00.000Z",
  ...
  // ภ.พ.30 เดือน พ.ค. → due 23 มิ.ย. 2569
  {
    id: "task-40",
    clientId: "client-1",
    client: c1,
  ...
  // ภ.ง.ด.50 FY ธ.ค.65 → due 30 พ.ค. 2569 (ยังไม่เกินกำหนด)
  {
    id: "task-37",
    clientId: "client-9",
    client: c9,
    ...
    priority: "CRITICAL",
    mddScore: 95.0,
    note: "งบการเงินผ่านผู้สอบบัญชีแล้ว รอ CFO sign-off",
    createdAt: "2026-01-05T00:00:00.000Z",
    updatedAt: "2026-05-01T00:00:00.000Z",
  },
];

...
**ตัวอย่างข้อความ LINE ที่ส่งจริง:**

REMINDER (D-7):
```
📋 [MALI] แจ้งเตือนงานภาษี (อีก 7 วัน)

งาน: ภ.พ.30
บริษัท: บริษัท ABC จำกัด
ครบกำหนด: 23 เมษายน 2569

กรุณาดำเนินการให้ทันกำหนด
```

ESCALATION (D-1 / Overdue):
```
🚨 [MALI] แจ้งเตือน Escalation

งาน: ภ.ง.ด.50
บริษัท: บริษัท ABC จำกัด
ครบกำหนด: 29 พฤษภาคม 2569
...
- ระบบแจ้งเตือนล่วงหน้า **7 วัน** (D-7) — ตรงกับ requirement และ code จริง
